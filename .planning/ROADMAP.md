...
Plans:
- [ ] 01-01: Docker Compose 骨架、环境变量配置与 DashScope 连通验证
- [ ] 01-02: 文档解析、中文分块与 DashScope Embedding 摄入流水线
- [ ] 01-03: ChromaDB 持久化存储与 `/health`、`/documents` 端点
